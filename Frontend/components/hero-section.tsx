          ...
          <div className="relative overflow-hidden w-full max-w-4xl mx-auto">
            <div className="flex items-center gap-8 opacity-60 hover:opacity-80 transition-all duration-500 animate-slide-left">
              <div className="flex items-center gap-8 whitespace-nowrap">
                ...
                <div className="text-base sm:text-lg font-semibold">Quality Foods</div>
                <div className="text-base sm:text-lg font-semibold">Logistics Pro</div>
          ...
          <div className="relative overflow-hidden w-full max-w-sm mx-auto">
            ...
            <div className="flex items-center gap-6 opacity-60 animate-slide-left-mobile">
              <div className="flex items-center gap-6 whitespace-nowrap">
                ...
                <div className="text-sm font-semibold">Quality Foods</div>
                <div className="text-sm font-semibold">Logistics Pro</div>
