...
const features = [
  {
    ...
    description:
      "High-speed barcode scanning system that instantly identifies products and retrieves manufacturing details from database.",
    demo: AnimatedChatDemo,
    size: "large",
  },
  {
    title: "AI-Powered Date Extraction",
    description:
      "Advanced OCR technology that accurately reads manufacturing and expiry dates from product packaging in real time.",
    demo: AnimatedPhoneDemo,
    size: "medium",
  },
  {
    title: "Shelf-Life Calculation",
    description:
      "Automatic calculation of remaining shelf life against configurable freshness thresholds and industry standards.",
  ...
  },
  {
    ...
    description:
      "Intelligent categorization into Accept, Priority Sale, or Reject based on freshness metrics and business rules.",
  ...
  },
  {
    ...
    description:
      "Seamless integration with warehouse management systems, ERPs, and inventory tracking platforms for automated workflows.",
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-3xl mx-auto font-light leading-relaxed">
              Automated barcode scanning, AI-powered date extraction, and intelligent shelf-life validation working seamlessly to keep expired products out of your inventory.
            </p>
          </div>
