...
export default function CommunityIntelligencePage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const clustersRes = await apiFetch<{ data: IssueCluster[] }>("/community/clusters?limit=100");
      ...
      const dashboardRes: ClusterDashboardResponse = (dashboardRaw as any).data || dashboardRaw as ClusterDashboardResponse;
                ...
                <div className="mt-4">
                  ...
                  <div className="mt-3 flex items-baseline gap-2">
                    <span className="text-2xl font-black text-amber-600 flex items-center">
                      ...
                      {dashboard.fastest_growing.risk_score * 2.5}%
                    </span>
                        ...
                        <tr key={p.id} className="hover:bg-gray-50/50">
                          ...
                          <td className="p-4">
                            <span className={`font-bold flex items-center ${
                              p.growth_rate > 50.0 ? "text-red-600" :
                              p.growth_rate > 0.0 ? "text-amber-600" : "text-green-600"
                            }`}>
                              {p.growth_rate > 0 ? "+" : ""}
                              {p.growth_rate}%
                            </span>
